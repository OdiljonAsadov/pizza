        ...
        <div class="container">
          <div class="row slider-text justify-content-center align-items-center">
            ...
            <div class="col-md-7 col-sm-12 text-center ftco-animate">
	            ...
	            <p class="breadcrumbs"><span class="mr-2"><a href="/">Bosh sahifa</a></span> <span>Biz haqimizda</span></p>
            </div>
    ...
    <section class="ftco-section">
      <div class="container">
          ...
          <div class="col-md-7 heading-section ftco-animate text-center">
            <h2 class="mb-4">Bizning jamoa</h2>
            <p class="flip"><span class="deg1"></span><span class="deg2"></span><span class="deg3"></span></p>
            <p class="mt-5">Biz eng yaxshi mutaxassislarga ega ekanligimizdan faxrlanamiz!</p>
          </div>
        </div>
        <div class="row">
			@foreach ($chefs as $chef)
				<div class="col-lg-3 d-flex mb-sm-4 ftco-animate">
					<div class="staff">
						<div class="img mb-4" style="background-image: url({{ $chef->image }});"></div>
						<div class="info text-center">
							<h3><a href="teacher-single.html">{{ $chef->name }}</a></h3>
							<span class="position">{{ $chef->name_profession }}</span>
							<div class="text">
    		...
    		<div class="row no-gutters d-md-flex align-items-center">
	    		...
	    		<div class="col-md-6 appointment ftco-animate">
	    			...
	    			<form action="/messages/add" method="post" class="appointment-form">
	    				...
	    				<div class="form-group">
	              <textarea name="message" id="message" cols="30" rows="3" class="form-control" placeholder="Xabaringizni yozing"></textarea>
	            </div>
	            <div class="form-group">
